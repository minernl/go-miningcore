...
//#cgo linux,amd64 LDFLAGS:-L${SRCDIR}/src/linux-x86_64 -lm
//#cgo linux,arm64 LDFLAGS:-L${SRCDIR}/src/linux-aarch64 -lm
//#cgo darwin,amd64 LDFLAGS:-L${SRCDIR}/src/macos-x86_64 -lm
//#cgo windows,amd64 LDFLAGS:-L${SRCDIR}/src/windows-x86_64 -static -static-libgcc -static-libstdc++
//#include <stdlib.h>
//#include "randomx.h"
import "C"
import (
